...
const int ENTREE_CLAW_CLOSE_VALUE = 995;
const int BOTTLE_ARM_RAISE_VALUE = 1600;
const int BOTTLE_ARM_LOWER_VALUE = 1988;
const int BOTTLE_ARM_STOW_VALUE = 550;
const int BOTTLE_CLAW_OPEN_VALUE = 1200;
const int BOTTLE_CLAW_CLOSE_VALUE = 1620;
...
void release_entrees() {
    enable_servo(ENTREE_CLAW_PIN); 
    slowly_set_servo_position(ENTREE_CLAW_PIN, 840);
    msleep(500);
    disable_servo(ENTREE_CLAW_PIN);
}
...
int main() {
    ...
    close_bottle_claw();
    stow_bottle_arm();
    move_forward_for_distance(29.5);
    close_entree_claw();
    move_backward_for_distance(14);
    move_right_for_distance(38);    
    ...
    turn_right_90_deg();
    turn_right_90_deg();
    move_forward_for_distance(12);
    release_entrees();
    close_entree_claw();
    //bottles
    open_bottle_claw();
    lower_bottle_arm();
    move_backward_for_distance(5);
    move_backward_for_distance(5);
    close_bottle_claw();
    msleep(500);
    raise_bottle_arm();
    turn_right_90_deg();
    turn_right_90_deg();
    move_left_for_distance(11.5);
    move_backward_for_distance(7);
    lower_bottle_arm();
    open_bottle_claw();
    //first set done, start of second set
    raise_bottle_arm();
    turn_right_90_deg();
    turn_right_90_deg();
    move_left_for_distance(8);
    move_forward_for_distance(10);
    lower_bottle_arm();
    move_backward_for_distance(6);
    move_left_for_distance(0.2);
    ...
    turn_left_90_deg();
    turn_left_90_deg();
    move_left_for_distance(7.5);
    move_forward_for_distance(8);
    lower_bottle_arm();
    move_backward_for_distance(8);
    move_left_for_distance(2.5);
    move_backward_for_distance(2);
    close_bottle_claw();
    msleep(500);
    raise_bottle_arm();
    turn_left_90_deg();
    turn_left_90_deg();
    move_left_for_distance(4.5);
    move_backward_for_distance(25);
    move_forward_for_distance(3);
    move_left_for_distance(4);
